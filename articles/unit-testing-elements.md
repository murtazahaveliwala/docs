...
In this tutorial, we're going to add an existing Polymer element, [`<core-selector>`](http://www.polymer-project.org/docs/elements/core-selector.html) to a fresh `<seed-element>` project as a feature. We're then going to write tests for it.

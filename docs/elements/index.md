...
<div horizontal layout start class="panel">
  ...
  <section flex layout vertical>
    <h2><a href="/docs/elements/core-ajax.html">{{site.project_title}} core elements</a></h2>
    ...
    <div horizontal layout>
      <a href="/docs/elements/core-ajax.html"><paper-button>Docs</paper-button></a>
...
<div horizontal layout center class="panel">
  <!-- <paper-shadow z="1"></paper-shadow> -->
  <section flex>
    <h2><a href="/docs/elements/paper-button.html">Paper elements</a></h2>
    ...
    <p>
      <a href="/docs/elements/paper-button.html"><paper-button>Docs</paper-button></a>
